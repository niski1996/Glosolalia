...
namespace Pars.Excell
{
	public class Parser
	{
		...
		public void GetseedEntityList(string filePath, List<ConfigInfo> configInfoSet, 
			out List<Word> wordSet, out List<PlWord> wordTranslationSet,out List<Sentence> sentenceSet,out List<PlSentence>sentenceTranslationSet)
		{
